...
import com.example.myhealth.presentation.screen.diabetesreadings.DiabetesReadingsScreen
import com.example.myhealth.presentation.screen.diabetesreadings.DiabetesReadingsViewModel
import com.example.myhealth.presentation.screen.diabetesreadings.DiabetesReadingsViewModelFactory
...
fun HealthConnectNavigation(
    ...
    NavHost(navController = navController, startDestination = Screen.WelcomeScreen.route) {
        ...
        composable(Screen.DiabetesReadings.route) {
            val viewModel: DiabetesReadingsViewModel = viewModel(
                factory = DiabetesReadingsViewModelFactory(
                    healthConnectManager = healthConnectManager
                )
            )
            val permissionsGranted by viewModel.permissionsGranted
            ...
            DiabetesReadingsScreen(
                ...
                onInsertClick = {
                    viewModel.generateDiabetesData()
                },
                onError = { exception ->
                    showExceptionSnackbar(scaffoldState, scope, exception)
                },
